...
#define ME     20        // Cantidad máxima de estudiantes
#define CRC    4         // Cantidad de rangos de calificación
#define MLR    12        // Máxima longitud de un rango
#define CC     4         // Cantidad de calificaciones, incluida la definitiva
#define LN     20        // Longitud del nombre, incluido el fin de cadena.
#define LC     5         // Longitud del carné, incluido el fin de cadena.
...
/* Escuela Colombiana de Ingeniería
   ...
   3. Contar los estudiantes por rango de la definitiva y escribir el resultado. Los rangos ya están definidos.
   
   Siéntanse en libertad de agregar campos a los tipos de datos ya definidos, de acuerdo con lo que se pide obtener. Les sugiero consultarme.
...
{
       char nombre[LN];
       char carne[LC];          // Cadena de caracteres numéricos
...
{
titulo("C U E N T A ESTUDIANTES por rango de calificación definitiva");
